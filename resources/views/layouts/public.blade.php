...
@php
  ...
  $logo_dark  = !empty($branding['logo_dark'])  ? \Illuminate\Support\Facades\Storage::url($branding['logo_dark'])   : null;
  $logo_light = !empty($branding['logo_light']) ? \Illuminate\Support\Facades\Storage::url($branding['logo_light'])  : null;
@endphp
